# README: Data Availability, De-identification, and Reproducibility
...
De-identified derived datasets and analysis scripts sufficient to reproduce the statistical analyses are publicly available at [repository/DOI]. The raw comment corpus is not publicly redistributed because it consists of potentially traceable user-generated social media content and may be subject to platform terms-of-service and copyright restrictions.
